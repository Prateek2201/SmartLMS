<%-- 
    Document   : adminreturn
    Created on : May 3, 2019, 4:57:35 PM
...
<html>
    ...
    <body>
        ...
        <form action="admincode/adminreturncode.jsp" method="post">
            <fieldset style="width: 60%;float: left;margin-left: 18%;">
            ...
            <table class="table">
                ...
                <tr>
                    <td></td>
                    <th style="text-align: center;font-size: 20px;">Date of Return</th>
