<%-- 
    Document   : complainmgmt
    Created on : May 22, 2019, 10:22:30 AM
...
<html>
    ...
    <body>
        ...
        <div id="content">
        <h1 style="text-align: center;color: darkcyan;">Complain Management</h1>
        ...
        <table class="table">
            <tr>
                        ...
                        <%
                            ...
                            ResultSet rs=db.selectQuery("select * from complain");
                            while(rs.next())
                            {
                        %>
                        <tr>
