<%-- 
    Document   : issue
    Created on : Mar 17, 2019, 10:42:45 PM
...
<html>
    ...
    <body>
        ...
        <form action="usercode/issuecode.jsp" method="post">
            <fieldset style="width: 30%;float: left;margin-left: 18%;">
            <table height="300px">
            ...
            <fieldset style="width: 30%;float: left;margin-left: 18px;">
            <table height="300px">
